...
TRAIN_FILE_PATH = ['./data/SemEval/3way/Beetle_train.csv']
TEST_FILE_PATH = ['./data/SemEval/3way/Beetle_test_UA.csv']

SEP_TOKEN = '[SEP]'
CLS_TOKEN = '[CLS]'

TAG2ID = {'incorrect': 0, 'correct': 1, 'contradictory': 2}

hyperparameters = dict(
    train_id="0118_beetle_UA3way_bs_bert",
